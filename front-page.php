...
<section class="hero section--hero">
	<div class="ft">
		<div class="ft__half">
			<h1 class="hero__title">De mogelijkheden zijn eindeloos, maar jouw
...
<section class="section--logos section--center">
	<div class="wr">
...
<section class="section--features features features-trio">
	<div class="wr">
		<div class="features features-trio features--center">
			<div class="feature">
				<h3 class="feature__title">Design</h3>
			...
			<div class="feature">
				<h3 class="feature__title">Website Ontwikkeling</h3>
				<div class="feature__description">
			...
			<div class="feature">
				<h3 class="feature__title   weight-text-m">Vragen, Nazorg en Hulp</h3>
				<div class="feature__description">
		...
		<div class="zigzag">
			<div class="zigzagItem zigzagItem--right">
				<div class="zigzagItem__content"><span class="zigzagItem__number">#1</span>
					<h3 class="zigzagItem__title   weight-text-m">Jij zegt het.</h3>
			...
			<div class="zigzagItem zigzagItem--left">
				...
				<div class="zigzagItem__content"><span class="zigzagItem__number">#2</span>
					<h3 class="zigzagItem__title   weight-text-m">De voorbereidingen.</h3>
					<div class="zigzagItem__text">
			...
			<div class="zigzagItem zigzagItem--right">
				<div class="zigzagItem__content"><span class="zigzagItem__number">#3</span>
					<h3 class="zigzagItem__title   weight-text-m">Starten met de website.</h3>
					<div class="zigzagItem__text">
			...
			<div class="zigzagItem zigzagItem--left">
				...
				<div class="zigzagItem__content"><span class="zigzagItem__number">#4</span>
					<h3 class="zigzagItem__title   weight-text-m">De puntjes op de i.</h3>
					<div class="zigzagItem__text">
			...
			<div class="zigzagItem zigzagItem--right">
				<div class="zigzagItem__content"><span class="zigzagItem__number">#5</span>
					<h3 class="zigzagItem__title   weight-text-m">Je website gaat live.</h3>
					<div class="zigzagItem__text">
...
<section class="section--pricing">
	<div class="wr">
		<h2 class="section__title">Eenvoudige, transparente prijzen.</h2>
		<p class="section__subtitle">Weet altijd waar je voor betaald.</p>
		<div class="pricing">
			<div id="pricingTiers_tqnxyzgabbq" class="pricingTiers active-a">
				<div class="pricingTierWrapper"
					...
					<div class="pricingTier">
						<h3 class="pricingTier__title   weight-text-m">Klein.</h3>
						<p class="pricingTier__description">Eenvoudige website</p>
						<div class="pricingTier__price a"><span class="price  ">€ 300</span></div>
						<ul class="pricingTier__features">
							<li class=" "><svg width="21px" height="17px" viewBox="0 0 21 17" version="1.1"
				...
				<div class="pricingTierWrapper"
					style="border-radius:5px;box-shadow:0 5px 15px 0 rgba(0,0,0,0.2);background-color:rgba(255, 255, 255, 1)">
					<div class="pricingTier">
						<h3 class="pricingTier__title   weight-text-m">Midden.</h3>
						<p class="pricingTier__description">Middelgrote omvang</p>
						<div class="pricingTier__price a"><span class="price  ">€ 500</span></div>
						<ul class="pricingTier__features">
							<li class=" "><svg width="21px" height="17px" viewBox="0 0 21 17" version="1.1"
									xmlns="http://www.w3.org/2000/svg"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="ui-icons" transform="translate(-109.000000, -67.000000)" fill="#22BC66"><polygon id="check" points="108.994099 76.4000626 115.987848 83.419577 129.407253 69.9978283 126.587674 67.1592372 115.987848 77.7490936 111.827057 73.5894775"></polygon></g></g></svg>
								<span>Webdesign en ontwikkeling</span></li>
				...
				<div class="pricingTierWrapper"
					style="border-radius:5px;box-shadow:0 5px 15px 0 rgba(0,0,0,0.2);background-color:rgba(255, 255, 255, 1)">
					<div class="pricingTier">
						<h3 class="pricingTier__title   weight-text-m">Groot.</h3>
						<p class="pricingTier__description">De grote website.</p>
						<div class="pricingTier__price a"><span class="price  ">€ 1200</span></div>
						<ul class="pricingTier__features">
							<li class=" "><svg width="21px" height="17px" viewBox="0 0 21 17" version="1.1"
									xmlns="http://www.w3.org/2000/svg"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="ui-icons" transform="translate(-109.000000, -67.000000)" fill="#22BC66"><polygon id="check" points="108.994099 76.4000626 115.987848 83.419577 129.407253 69.9978283 126.587674 67.1592372 115.987848 77.7490936 111.827057 73.5894775"></polygon></g></g></svg>
								<span>Webdesign en ontwikkeling</span></li>
		...
		<div class="ft__half">
			<div class="ft__wrapper" style="max-width:570px">
				<div class="ft__content">
					<h2 class="  weight-title-h font-title section__title left noMargin">En verder...</h2>
					...
					<div class="ftPoint">
						...
						<div class="ftPoint__meta">
							<h3 class="ftPoint__title   weight-text-m">Lage kosten</h3>
					...
					<div class="ftPoint">
						...
						<div class="ftPoint__meta">
							<h3 class="ftPoint__title   weight-text-m">Helderheid en vertrouwen</h3>
							<div class="ftPoint__description">
					...
					<div class="ftPoint">
						...
						<div class="ftPoint__meta">
							<h3 class="ftPoint__title   weight-text-m">Eenvoudig</h3>
							<div class="ftPoint__description">
...
<section class="section--email">
	<div class="wr">
		<h2 class="section__title">De inschrijving voor 2020 is geopend.</h2>
...
<section class="section--testimonials">
	<div class="wr">
		<h2 class="section__title">Reviews doen het altijd goed.</h2>
		<p class="section__subtitle">Wat je voorgangers ervan vinden.</p>
		<ul class="testimonials">
			...
			<li class="testimonial">
				...
				<span class="testimonial__name weight-text-m">Froukje Drent — </span><a
...
<section class="section--contact">
	<div class="wr">
		...
		<p class="section__subtitle">Heb je vragen? Vul even dat formuliertje in en verstuur je
			vraag!</p>
			<div class="contact">
...
<section class="section--faq">
	<div class="wr">
		<h2 class="section__title">Nog meer vragen?</h2>
		<p class="section__subtitle">Soms heb je geen zin om het contactformulier in te vullen.</p>
		<div class="faq">
			<div class="faqItem">
